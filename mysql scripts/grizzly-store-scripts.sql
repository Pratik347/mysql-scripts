...
delete from product_management where product_id = 6;
...
delete from inventory_management where product_id = 10; 
...
insert into login_user values ('Pratik','Pratik','Admin',4.9,'9000000001','Bihar','enabled');
...
update login_user set login_status='enabled' where login_username='Pratik';
